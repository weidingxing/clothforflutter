...
import 'package:graduationproject/views/loginPage/SiginIn.dart';
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  if (_formKey.currentState.validate()) {
                   ...
                   HttpUtil.post(NetConfig.SELECT,formData: data).then((value){
                     if(value=="fails")
                       {
                       ...
                       {
                         List<String> user=[_username,_password];
                         Provider.of<PUserInfo>(context, listen: false).saveUser(user);
                         Navigator.of(context).pushAndRemoveUntil(
                             new MaterialPageRoute(builder: (context) => new MyApp()
                             ), (route) => route == null);
//                         Application.router.navigateTo(context, "/Index",transition: TransitionType.fadeIn);
                       }
                   });
                  }
                },
                child: FlareActor(
                  "icons/Fingerprintv.flr",
